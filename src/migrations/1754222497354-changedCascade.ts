...
export class ChangedCascade1754222497354 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "server_member" ADD CONSTRAINT "FK_57806110c6ca99dbd5e6b1dd729" FOREIGN KEY ("serverId") REFERENCES "server"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
