...
router.post("/create", verifyTokenMiddleware, checkUserPermission(PermissionType.MANAGE_SERVER), channelController.createChannel);
router.post("/direct/create", verifyTokenMiddleware, channelController.createDirectChannel);
router.put("/update", verifyTokenMiddleware, checkUserPermission(PermissionType.MANAGE_SERVER), channelController.updateChannel);
